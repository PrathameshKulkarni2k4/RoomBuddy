...
const getCurrentUser = asyncHandler(async(req,res) => {
    return res
    .status(200)
    .json(200, req.user, "current userr fetched successfully")
})
...
const updateUserAvatar = asyncHandler(async(req,res) => {
    ...
    if (!avatar.url) {
        throw new ApiError(400,"Error while uploading 0n avatar");
    }
...
const updateUserCoverImage = asyncHandler(async(req,res) => {
    ...
    if (!coverImage.url) {
        throw new ApiError(400,"Error while uploading 0n cover image");
    }
